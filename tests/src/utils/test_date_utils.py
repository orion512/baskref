...
class TestDateUtils:
    ...
    test_dates = [
        ...
        ("202207-08", ArgumentTypeError("not a valid date: '202207-08'")),
        ("2022-13-08", ArgumentTypeError),
        ("2000/07/08", ArgumentTypeError),
        ("2022-09-31", ArgumentTypeError),
        ("20220708", ArgumentTypeError),
    ]

    @pytest.mark.unittest
    @pytest.mark.parametrize("str_date, expected_status", test_dates)
    def test_valid_date(self, str_date, expected_status):
