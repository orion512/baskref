...
class BasketballReference:
    ...
    def scrape_game_data(self, game_url: str) -> dict:
        ...
        # Team names 
        home_team_full_name, home_team = self.__parse_team_name(game_page, 1)
        away_team_full_name, away_team = self.__parse_team_name(game_page, 2)
